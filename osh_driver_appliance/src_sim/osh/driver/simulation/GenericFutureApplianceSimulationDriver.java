    ...
    public void performNextAction(SubjectAction nextAction) {
        ...
        //if the next state is true the i-appliance is filled up and is now able to run
            ...
            if (this.isControllable()) {
                ...
                this.configurationStartedAt = this.getTimeDriver().getUnixTime();
...
//				selectedNextProfileID = null; //safety first
            ...
            while (selectedStartTimeAndDofs == null) {
                ...
                if (errorCount == 40) {
                    ...
                    if (lastDay) {
                        ...
                        long endOfSim = this.getSimulationEngine().getSimulationDuration() + this.getTimeDriver().getUnixTimeAtStart();
    ...
    private Long[][] generateStartTimesAndTDofs(int numberToGenerate, int[] selectedProfileLengths, OSHRandomGenerator randomGen,
        ...
        for (int i = 0; i < numberToGenerate; i++) {
            ...
            if (startTime < this.getTimeDriver().getUnixTimeAtStart() + 100) {
                startTime = 100;
            }
            ...
            if (lastDay && currentEnd >= this.getTimeDriver().getUnixTimeAtStart() + this.getSimulationEngine().getSimulationDuration())
                return null;
