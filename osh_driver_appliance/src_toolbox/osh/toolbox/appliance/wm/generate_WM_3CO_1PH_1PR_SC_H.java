...
public class generate_WM_3CO_1PH_1PR_SC_H {
    ...
    // device data
    static final ToolApplianceConfiguration[] wpConfigs = WM_3CO_1PH_1PR_SC_H.configurations;

    static final String outputFile = "data/profiles/out/wm/WM_3CO_1PH_1PR_SC_H.xml";
