 ...
 * 
 */
public class generate_WM_3CO_1PH_1PR_SC_H {

	// for JAXBContext
	static String contextPath = "osh.configuration.appliance";
	
	// device data
	static ToolApplianceConfiguration[] wpConfigs = WM_3CO_1PH_1PR_SC_H.configurations;
	
	static String outputFile = "data/profiles/out/wm/WM_3CO_1PH_1PR_SC_H.xml";
