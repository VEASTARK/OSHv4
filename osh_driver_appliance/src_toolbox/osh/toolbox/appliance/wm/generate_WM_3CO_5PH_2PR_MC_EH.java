 ...
 * 
 */
public class generate_WM_3CO_5PH_2PR_MC_EH {

	// for JAXBContext
	static String contextPath = "osh.configuration.appliance";
	
	// device data
	static ToolApplianceConfiguration[] wpConfigs = WM_3CO_5PH_2PR_MC_EH.configurations;
	
	static String outputFile = "data/profiles/out/wm/WM_3CO_5PH_2PR_MC_EH.xml";
