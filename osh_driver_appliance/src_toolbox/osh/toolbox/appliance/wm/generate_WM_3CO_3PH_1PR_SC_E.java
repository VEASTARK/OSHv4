 ...
 * @author Ingo Mauser
 */
public class generate_WM_3CO_3PH_1PR_SC_E {

    // for JAXBContext
    static final String contextPath = "osh.configuration.appliance";

    // device data
    static final ToolApplianceConfiguration[] wpConfigs = WM_3CO_3PH_1PR_SC_E.configurations;

    static final String outputFile = "data/profiles/out/wm/WM_3CO_3PH_1PR_SC_E.xml";
