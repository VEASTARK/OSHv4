 ...
 * @author Ingo Mauser
 */
public class generate_IH_3CO_1PH_2PR_MC_EG {

    // for JAXBContext
    static final String contextPath = "osh.configuration.appliance";

    // device data
    static final ToolApplianceConfiguration[] wpConfigs = IH_3CO_1PH_2PR_MC_EG.configurations;

    static final String outputFile = "data/profiles/out/ih/IH_3CO_1PH_2PR_MC_EG.xml";
