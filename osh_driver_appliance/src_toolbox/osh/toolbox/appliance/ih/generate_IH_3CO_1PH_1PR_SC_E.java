 ...
 * @author Ingo Mauser
 */
public class generate_IH_3CO_1PH_1PR_SC_E {

    // for JAXBContext
    static final String contextPath = "osh.configuration.appliance";

    // device data
    static final ToolApplianceConfiguration[] wpConfigs = IH_3CO_1PH_1PR_SC_E.configurations;

    static final String outputFile = "data/profiles/out/ih/IH_3CO_1PH_1PR_SC_E.xml";
