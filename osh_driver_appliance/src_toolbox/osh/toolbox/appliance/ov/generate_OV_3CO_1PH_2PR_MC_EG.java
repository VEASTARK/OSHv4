 ...
 * @author Ingo Mauser
 */
public class generate_OV_3CO_1PH_2PR_MC_EG {

    // for JAXBContext
    static final String contextPath = "osh.configuration.appliance";

    // device data
    static final ToolApplianceConfiguration[] wpConfigs = OV_3CO_1PH_2PR_MC_EG.configurations;

    static final String outputFile = "data/profiles/out/ov/OV_3CO_1PH_2PR_MC_EG.xml";
