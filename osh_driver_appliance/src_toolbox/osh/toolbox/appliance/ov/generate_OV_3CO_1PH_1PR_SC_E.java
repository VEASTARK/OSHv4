 ...
 * @author Ingo Mauser
 */
public class generate_OV_3CO_1PH_1PR_SC_E {

    // for JAXBContext
    static final String contextPath = "osh.configuration.appliance";

    // device data
    static final ToolApplianceConfiguration[] wpConfigs = OV_3CO_1PH_1PR_SC_E.configurations;

    static final String outputFile = "data/profiles/out/ov/OV_3CO_1PH_1PR_SC_E.xml";
