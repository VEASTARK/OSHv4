 ...
 * @author Ingo Mauser
 */
public class DW_4CO_1PH_2PR_MC_EH {
            ...
            new ToolApplianceConfiguration(
                    ...
                    new ToolApplianceConfigurationProfile[]{
                            new ToolApplianceConfigurationProfile(
                                    ...
                                    new String[]{"data/profiles/renamed/dw/DW_0.csv",},
                                    0, 1, -1, -1),
                            new ToolApplianceConfigurationProfile(
                                    1,
            ...
            new ToolApplianceConfiguration(
                    ...
                    new ToolApplianceConfigurationProfile[]{
                            new ToolApplianceConfigurationProfile(
                                    ...
                                    new String[]{"data/profiles/renamed/dw/DW_1.csv",},
                                    0, 1, -1, -1),
                            new ToolApplianceConfigurationProfile(
                                    1,
                                    "hybrid uninterruptible",
            ...
            new ToolApplianceConfiguration(
                    ...
                    new ToolApplianceConfigurationProfile[]{
                            new ToolApplianceConfigurationProfile(
                                    ...
                                    new String[]{"data/profiles/renamed/dw/DW_2.csv",},
                                    0, 1, -1, -1),
                            new ToolApplianceConfigurationProfile(
                                    1,
                                    "hybrid uninterruptible",
            ...
            new ToolApplianceConfiguration(
                    ...
                    new ToolApplianceConfigurationProfile[]{
                            new ToolApplianceConfigurationProfile(
                                    ...
                                    new String[]{"data/profiles/renamed/dw/DW_3.csv",},
                                    0, 1, -1, -1),
                            new ToolApplianceConfigurationProfile(
                                    1,
                                    "hybrid uninterruptible",
