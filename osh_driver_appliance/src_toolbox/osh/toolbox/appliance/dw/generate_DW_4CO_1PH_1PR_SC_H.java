...
public class generate_DW_4CO_1PH_1PR_SC_H {
    ...
    // device data
    static final ToolApplianceConfiguration[] wpConfigs = DW_4CO_1PH_1PR_SC_H.configurations;

    static final String outputFile = "data/profiles/out/dw/DW_4CO_1PH_1PR_SC_H.xml";
