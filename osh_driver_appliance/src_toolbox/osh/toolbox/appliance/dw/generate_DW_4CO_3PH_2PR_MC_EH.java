 ...
 * 
 */
public class generate_DW_4CO_3PH_2PR_MC_EH {

	// for JAXBContext
	static String contextPath = "osh.configuration.appliance";
	
	// device data
	static ToolApplianceConfiguration[] wpConfigs = DW_4CO_3PH_2PR_MC_EH.configurations;
	
	static String outputFile = "data/profiles/out/dw/DW_4CO_3PH_2PR_MC_EH.xml";
