...
public class generate_DW_4CO_3PH_2PR_MC_EH {
    ...
    // device data
    static final ToolApplianceConfiguration[] wpConfigs = DW_4CO_3PH_2PR_MC_EH.configurations;

    static final String outputFile = "data/profiles/out/dw/DW_4CO_3PH_2PR_MC_EH.xml";
