...
public class generate_TD_3CO_1PH_2PR_MC_EH {
    ...
    // device data
    static final ToolApplianceConfiguration[] wpConfigs = TD_3CO_1PH_2PR_MC_EH.configurations;

    static final String outputFile = "data/profiles/out/td/TD_3CO_1PH_2PR_MC_EH.xml";
