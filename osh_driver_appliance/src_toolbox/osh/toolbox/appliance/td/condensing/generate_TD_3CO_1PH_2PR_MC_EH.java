 ...
 * 
 */
public class generate_TD_3CO_1PH_2PR_MC_EH {

	// for JAXBContext
	static String contextPath = "osh.configuration.appliance";
	
	// device data
	static ToolApplianceConfiguration[] wpConfigs = TD_3CO_1PH_2PR_MC_EH.configurations;
	
	static String outputFile = "data/profiles/out/td/TD_3CO_1PH_2PR_MC_EH.xml";
