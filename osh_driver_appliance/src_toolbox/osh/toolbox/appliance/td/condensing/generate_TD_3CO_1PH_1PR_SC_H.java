 ...
 * 
 */
public class generate_TD_3CO_1PH_1PR_SC_H {

	// for JAXBContext
	static String contextPath = "osh.configuration.appliance";
	
	// device data
	static ToolApplianceConfiguration[] wpConfigs = TD_3CO_1PH_1PR_SC_H.configurations;
	
	static String outputFile = "data/profiles/out/td/TD_3CO_1PH_1PR_SC_H.xml";
