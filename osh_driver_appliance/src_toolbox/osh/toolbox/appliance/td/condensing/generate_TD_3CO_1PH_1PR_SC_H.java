...
public class generate_TD_3CO_1PH_1PR_SC_H {
    ...
    // device data
    static final ToolApplianceConfiguration[] wpConfigs = TD_3CO_1PH_1PR_SC_H.configurations;

    static final String outputFile = "data/profiles/out/td/TD_3CO_1PH_1PR_SC_H.xml";
