 ...
 * 
 */
public class generate_TD_3CO_9PH_1PR_SC_E {

	// for JAXBContext
	static String contextPath = "osh.configuration.appliance";
	
	// device data
	static ToolApplianceConfiguration[] wpConfigs = TD_3CO_9PH_1PR_SC_E.configurations;
	
	static String outputFile = "data/profiles/out/td/TD_3CO_9PH_1PR_SC_E.xml";
