 ...
 * 
 */
public class generate_TD_3CO_3PH_2PR_MC_EH {

	// for JAXBContext
	static String contextPath = "osh.configuration.appliance";
	
	// device data
	static ToolApplianceConfiguration[] wpConfigs = TD_3CO_3PH_2PR_MC_EH.configurations;
	
	static String outputFile = "data/profiles/out/td/TD_3CO_3PH_2PR_MC_EH.xml";
				...
				for (int i = 0; i < numberOfPhases; i++) {
					...
					for (int j = 0; j < phaseValues.length; j++) {
						...
						if (profile.domesticHotWaterPowerColumn >= 0) {
							...
							ap.setValue(phaseValues[j][profile.domesticHotWaterPowerColumn]);
						}
					}
