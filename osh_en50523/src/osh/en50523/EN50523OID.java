...
public enum EN50523OID {
    ...
    private final EN50523Cluster cluster;
    private final EN50523Category category;
     ...
     * @param category
     */
    EN50523OID(byte oid, EN50523Cluster cluster, EN50523Category category, String descriptionEN, String descriptionDE) {
        this.oid = oid;
