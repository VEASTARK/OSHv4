...
public class VirtualPriceSignalGenerator {
    ...
    public static PriceSignal getRandomH0BasedPriceSignal(
        ...
        double deviationMinPriceInPercent = maxDeviationMinPriceInPercent;
        if (!deviatePrice) {
            deviationMinPriceInPercent = 0;
        ...
        for (long i = startTime; i < endTime; i += constantPeriod) {
            ...
            double newCurrentDevActiveMinAbsolute =
                    (1 - newCurrentDeviationActiveMinPercent) * deviationMinPriceInPercent
                            + newCurrentDeviationActiveMinPercent * deviationMaxPriceInPercent;
            double newCurrentDevActiveMaxAbsolute =
                    newCurrentDeviationActiveMaxPercent * deviationMinPriceInPercent
                            + (1 - newCurrentDeviationActiveMaxPercent) * deviationMaxPriceInPercent;
            ...
            newActiveValue -= newCurrentDeviationActiveAbsolute;
            ...
            double finalActiveValue = newActiveValue / 10.0;
    ...
    public static PriceSignal getTriangularComplexPriceSignal(
        ...
        long numberOfPriceStepsStartTillPeak = (adjustedPeakTime - startTime) / constantPeriod;
        long numberOfPriceStepsPeakTillEnd = (endTime - adjustedPeakTime) / constantPeriod;
        ...
        for (long i = 0; i < numberOfPriceStepsPeakTillEnd; i++) {
            ...
            long timestamp = adjustedPeakTime + i * constantPeriod;
