...
//					/ numberOfSteps;
    ...
    public static PowerLimitSignal getH0basedPowerLimitSignal(
            ...
            PowerInterval upperAndLowerPositiveInterval) {
        ...
        double powerLimitDiff = upperAndLowerPositiveInterval.getPowerUpperLimit() - upperAndLowerPositiveInterval.getPowerLowerLimit();
        double priceDiff = maxPrice - minPrice;

        for (long i = signalStartTime; i < signalEndTime; i = priceSignal.getNextPriceChange(i)) {

            double currentPrice = priceSignal.getPrice(i);
            double powerLimit = (1 - ((currentPrice - minPrice) / priceDiff)) * powerLimitDiff + upperAndLowerPositiveInterval.getPowerLowerLimit();
    ...
    public static PowerLimitSignal getTriangularPowerLimitSignal(
        ...
        long numberOfStepsStartTillPeak = (adjustedPeakTime - startTime) / constantPeriod;
        long numberOfStepsPeakTillEnd = (endTime - adjustedPeakTime) / constantPeriod;
