...
public class DummyDoFProviderComDriver extends CALComDriver {
    ...
    final HashMap<UUID, Integer> device1stDegreeOfFreedom;
    final HashMap<UUID, Integer> device2ndDegreeOfFreedom;
    ...
    public void onSystemIsUp() throws OSHException {
        ...
        this.processDofInformation();
    }


    private void processDofInformation() {

        DofComExchange dce = new DofComExchange(this.getDeviceID(), this.getTimer().getUnixTime());
