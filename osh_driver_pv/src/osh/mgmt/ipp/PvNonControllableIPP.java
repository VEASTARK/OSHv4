	...
	public void initializeInterdependentCalculation(
		...
		if (outputStatesCalculatedFor != maxReferenceTime) {
			...
			while (time < maxHorizon) {
				...
				double actPower = predictedPVProfile.getAverageLoadFromTill(Commodity.ACTIVEPOWER, time, time + stepSize);
				double reactPower = predictedPVProfile.getAverageLoadFromTill(Commodity.REACTIVEPOWER, time, time + stepSize);
