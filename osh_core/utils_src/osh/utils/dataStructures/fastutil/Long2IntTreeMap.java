 ...
 *
 */
public class Long2IntTreeMap extends AbstractLong2IntSortedMap implements java.io.Serializable, Cloneable {
     ...
     */
    public Long2IntTreeMap(final long[] k, final int[] v, final Comparator<? super Long> c) {
        this(c);
     ...
     *             if {@code k} and {@code v} have different lengths.
     */
    public Long2IntTreeMap(final long[] k, final int[] v) {
        this(k, v, null);
    }
    /*
    ...
    private final class Submap extends AbstractLong2IntSortedMap implements java.io.Serializable {
        ...
        public Submap(final long from, final boolean bottom, final long to, final boolean top) {
            if (!bottom && !top && Long2IntTreeMap.this.compare(from, to) > 0)
                throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
            this.from = from;
            this.bottom = bottom;
            this.to = to;
            this.top = top;
            this.defRetValue = Long2IntTreeMap.this.defRetValue;
        }
        @Override
        public void clear() {
            ...
            if (entries == null)
                entries = new AbstractObjectSortedSet<Entry>() {
                    ...
                    public Comparator<? super Entry> comparator() {
                        return Long2IntTreeMap.this.long2IntEntrySet().comparator();
                    }
                    @Override
    ...
    public Long2IntTreeMap clone() {
        Long2IntTreeMap c;
        try {
            c = (Long2IntTreeMap) super.clone();
        } catch (CloneNotSupportedException cantHappen) {
            throw new InternalError();
        }
        c.keys = null;
