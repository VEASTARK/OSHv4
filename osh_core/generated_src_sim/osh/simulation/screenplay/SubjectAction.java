...
public class SubjectAction {
    ...
    protected List<osh.simulation.screenplay.PerformAction> performAction;
     ...
     * 
     */
    public List<osh.simulation.screenplay.PerformAction> getPerformAction() {
        if (performAction == null) {
            performAction = new ArrayList<osh.simulation.screenplay.PerformAction>();
        }
