...
//		trySetupConnection();
    ...
    public static void enqueueHotWater(double[][] aggrWeekdaysResults, double[] aggrDaysResults, Commodity hotWater) {
        ...
        switch (hotWater) {
            case DOMESTICHOTWATERPOWER:
                hotWaterIdentifier = "DOM";
                break;
            case HEATINGHOTWATERPOWER:
                hotWaterIdentifier = "SPACE";
                break;
            default:
                break;
        }
    ...
    public static void enqueueBaseload(double activePower, double relativePower) {
        BaseloadLogObject logInf = new BaseloadLogObject(activePower, relativePower);
        enqueue(logInf);
    }
    ...
    private static class SimulationLogObject extends QueueLogObject {
        ...
        public final OSHSimulationResults simResults;
        public final long relativeStart;
        public final long relativeEnd;
    ...
    private static class EpsLogObject extends QueueLogObject {
        public final Map<AncillaryCommodity, PriceSignal> eps;
    ...
    private static class PlsLogObject extends QueueLogObject {
        public final Map<AncillaryCommodity, PowerLimitSignal> pls;
    ...
    private static class DetailedPowerLogObject extends QueueLogObject {
        public final AncillaryCommodityLoadProfile loadProfile;
    ...
    private static class H0LogObject extends QueueLogObject {
        private final double[][][] aggrWeekdayResults;
        private final double[][] aggrDayResults;
    ...
    private static class HotWaterLogObject extends QueueLogObject {
        private final double[][] aggrWeekdayResults;
        private final double[] aggrDayResults;
        private final String hotWaterIdentifier;
