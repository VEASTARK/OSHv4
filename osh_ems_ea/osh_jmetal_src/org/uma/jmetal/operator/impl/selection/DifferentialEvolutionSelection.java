...
public class DifferentialEvolutionSelection implements SelectionOperator<List<DoubleSolution>, List<DoubleSolution>> {
    ...
    public List<DoubleSolution> execute(List<DoubleSolution> solutionSet) {
        ...
        } else if ((this.solutionListIndex < 0) || (this.solutionListIndex > solutionSet.size())) {
            throw new JMetalException(
                    "Index value invalid: " + this.solutionListIndex);
        ...
        do {
            r1 = this.randomGenerator.getRandomValue(0, solutionSet.size() - 1);
        } while (r1 == this.solutionListIndex);
        do {
            r2 = this.randomGenerator.getRandomValue(0, solutionSet.size() - 1);
        } while (r2 == this.solutionListIndex || r2 == r1);
        do {
            r3 = this.randomGenerator.getRandomValue(0, solutionSet.size() - 1);
        } while (r3 == this.solutionListIndex || r3 == r1 || r3 == r2);
