...
public class ListenerTimeMeasure extends SimplePullMeasure<Long> implements
    ...
    public <Value> MeasureListener<Value> wrapListener(
        ...
        if (wrapped == null) {
            ...
            MeasureListener<Value> wrapper = (MeasureListener<Value>) this.listenerCache
                    .get(wrapped);
            ...
            if (wrapper == null) {
                wrapper = value -> {
                    ...
                    ListenerTimeMeasure.this.time += stop - Math.max(start, ListenerTimeMeasure.this.lastReset);
                };
    ...
    public <Value> PushMeasure<Value> wrapMeasure(
        ...
        if (wrapped == null) {
            ...
            @SuppressWarnings("unchecked")
            PushMeasure<Value> wrapper = (PushMeasure<Value>) this.measureCache
                    .get(wrapped);

            if (wrapper == null) {
                wrapper = new PushMeasure<>() {
                    ...
                    public void register(MeasureListener<Value> listener) {
                        wrapped.register(ListenerTimeMeasure.this.wrapListener(listener));
                    }

                    @Override
                    public void unregister(MeasureListener<Value> listener) {
                        wrapped.unregister(ListenerTimeMeasure.this.wrapListener(listener));
                    }
                };
            ...
            if (measureKey != null) {
                wrapper = new MeasureManager() {
                    ...
                    public <T> PushMeasure<T> getPushMeasure(Object key) {
                        return ListenerTimeMeasure.this.wrapMeasure(wrapped.getPushMeasure(key));
                    }
