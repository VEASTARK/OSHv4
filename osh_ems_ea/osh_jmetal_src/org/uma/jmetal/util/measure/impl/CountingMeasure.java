...
public class CountingMeasure extends SimplePushMeasure<Long> implements
    ...
    public <T> void link(PushMeasure<T> measure) {
        if (this.linkedMeasures.containsKey(measure)) {
            ...
            MeasureListener<T> listener = value -> CountingMeasure.this.increment();
    ...
    public <T> void unlink(PushMeasure<T> measure) {
        MeasureListener<T> listener = (MeasureListener<T>) this.linkedMeasures
                .get(measure);
        if (listener == null) {
