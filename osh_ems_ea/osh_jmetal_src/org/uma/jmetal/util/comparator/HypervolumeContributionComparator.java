...
public class HypervolumeContributionComparator<S extends Solution<?>> implements Comparator<S>, Serializable {
    private final HypervolumeContributionAttribute<S> hvContribution = new HypervolumeContributionAttribute<>();
    ...
    public int compare(S solution1, S solution2) {
        ...
        if (solution1 == null) {
            ...
            if (this.hvContribution.getAttribute(solution1) != null) {
                contribution1 = this.hvContribution.getAttribute(solution1);
            }

            if (this.hvContribution.getAttribute(solution2) != null) {
                contribution2 = this.hvContribution.getAttribute(solution2);
            }
