...
public class FitnessComparator<S extends Solution<?>> implements Comparator<S>, Serializable {
    private final Fitness<S> solutionFitness = new Fitness<>();
    ...
    public int compare(S solution1, S solution2) {
        ...
        double fitness1 = this.solutionFitness.getAttribute(solution1);
        double fitness2 = this.solutionFitness.getAttribute(solution2);
