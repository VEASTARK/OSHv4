...
public class RankingComparator<S extends Solution<?>> implements Comparator<S>, Serializable {
    private final Ranking<S> ranking = new DominanceRanking<>();
    ...
    public int compare(S solution1, S solution2) {
        ...
        if (solution1 == null) {
            ...
            if (this.ranking.getAttribute(solution1) != null) {
                rank1 = this.ranking.getAttribute(solution1);
            }

            if (this.ranking.getAttribute(solution2) != null) {
                rank2 = this.ranking.getAttribute(solution2);
            }
