...
public class ObjectiveComparator<S extends Solution<?>> implements Comparator<S>, Serializable {
    ...
    public int compare(S solution1, S solution2) {
        ...
        if (solution1 == null) {
            ...
            result = -1;
        } else if (solution1.getNumberOfObjectives() <= this.objectiveId) {
            throw new JMetalException("The solution1 has " + solution1.getNumberOfObjectives() + " objectives "
                    + "and the objective to sort is " + this.objectiveId);
        } else if (solution2.getNumberOfObjectives() <= this.objectiveId) {
            ...
            if (this.order == Ordering.ASCENDING) {
