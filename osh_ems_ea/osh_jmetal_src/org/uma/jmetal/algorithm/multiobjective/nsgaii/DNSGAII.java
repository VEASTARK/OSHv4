...
public class DNSGAII<S extends Solution<?>> extends NSGAII<S> {
    ...
    protected List<S> replacement(List<S> population, List<S> offspringPopulation) {
        ...
        RankingAndDirScoreSelection<S> rankingAndDirScoreSelection = new RankingAndDirScoreSelection<>(this.getMaxPopulationSize(), this.dominanceComparator, this.referenceVectors);
