...
public class PESA2Selection extends Selection {
    ...
    public Object execute(Object object) throws JMException {
        try {
            ...
            int selected;
            int hypercube1 = archive.getGrid().randomOccupiedHypercube(this.pseudoRandom);
            int hypercube2 = archive.getGrid().randomOccupiedHypercube(this.pseudoRandom);
            ...
            int base = this.pseudoRandom.randInt(0, archive.size() - 1);
            int cnt = 0;
