...
public class BinaryTournament2 extends Selection {
    ...
    public Object execute(Object object) {
        ...
        if (this.index_ == 0) //Create the permutation
        {
            this.a_ = (new jmetal.util.PermutationUtility()).intPermutation(population.size(), this.pseudoRandom);
        }


        Solution solution1, solution2;
        solution1 = population.get(this.a_[this.index_]);
        solution2 = population.get(this.a_[this.index_ + 1]);
