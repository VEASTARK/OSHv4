...
public class PMXCrossover extends Crossover {
    ...
    public Solution[] doCrossover(double probability,
        ...
        if (this.pseudoRandom.randDouble() < probability) {
            ...
            cuttingPoint1 = this.pseudoRandom.randInt(0, permutationLength - 1);
            cuttingPoint2 = this.pseudoRandom.randInt(0, permutationLength - 1);
    ...
    public Object execute(Object object) throws JMException {
        ...
        return this.doCrossover(crossoverProbability,
                parents[0],
                parents[1]);
    } // execute
} // PMXCrossover
