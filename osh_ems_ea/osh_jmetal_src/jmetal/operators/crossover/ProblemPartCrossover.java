...
public class ProblemPartCrossover extends Crossover {
    ...
    private int[] problemPartBoundaries_;
    ...
    public ProblemPartCrossover(HashMap<String, Object> parameters, PseudoRandom pseudoRandom) {
        ...
        if (parameters.get("problemPartBoundarys") != null)
            this.problemPartBoundaries_ = (int[]) parameters.get("problemPartBoundarys");
...
//	TODO: Making the crossover work multiple decision variables
        ...
        try {
            ...
            if (this.pseudoRandom.randDouble() < probability) {
                ...
                if (this.problemPartBoundaries_ == null || this.problemPartBoundaries_.length < 2) {
                    int startswap = this.pseudoRandom.randInt(0, parent1.getNumberOfBits());
                    ...
                    for (int i = 1; i < this.problemPartBoundaries_.length; i += 2) {
                        startswap = this.problemPartBoundaries_[i - 1];
                        endswap = this.problemPartBoundaries_[i];
