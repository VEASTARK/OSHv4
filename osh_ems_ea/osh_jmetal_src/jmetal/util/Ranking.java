...
public class Ranking {
    ...
    public Ranking(SolutionSet solutionSet) {
        ...
        List<Integer>[] iDominate = new List[this.solutionSet_.size()];

        // front[i] contains the list of individuals belonging to the front i
        List<Integer>[] front = new List[this.solutionSet_.size() + 1];
    ...
    */
        ...
        for (int p = 0; p < this.solutionSet_.size(); p++) {
            // Initialize the list of individuals that i dominate and the number
            // of individuals that dominate me
            iDominate[p] = new LinkedList<>();
            dominateMe[p] = 0;
        }
        for (int p = 0; p < (this.solutionSet_.size() - 1); p++) {
            // For all q individuals , calculate if p dominates q or vice versa
        ...
        for (int j = 0; j < i; j++) {
            ...
            while (it1.hasNext()) {
                this.ranking_[j].add(solutionSet.get(it1.next()));
            }
        }
