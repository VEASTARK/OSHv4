...
public class Neighborhood {
     ...
     */
    private static final int MAXRADIO = 2;
     ...
     */
    private final int[][][] structure_;

    /**
     * Stores the size of the solutionSet.
     */
    private final int solutionSetSize_;
    ...
    public Neighborhood(int solutionSetSize) {
        ...
        for (int ind = 0; ind < this.solutionSetSize_; ind++) {
        ...
        for (int ind = 0; ind < this.solutionSetSize_; ind++) {
            //rate 1
            //North neighbors
            if (ind > this.rowSize_ - 1) {
                this.structure_[ind][0][Row.N.ordinal()] = ind - this.rowSize_;
            } else {
                this.structure_[ind][0][Row.N.ordinal()] =
                        (ind - this.rowSize_ + solutionSetSize) % solutionSetSize;
            }

            //East neighbors
            if ((ind + 1) % this.rowSize_ == 0)
                this.structure_[ind][0][Row.E.ordinal()] = (ind - (this.rowSize_ - 1));
            else
                this.structure_[ind][0][Row.E.ordinal()] = (ind + 1);

            //Western neigbors
            if (ind % this.rowSize_ == 0) {
                this.structure_[ind][0][Row.W.ordinal()] = (ind + (this.rowSize_ - 1));
            } else {
                this.structure_[ind][0][Row.W.ordinal()] = (ind - 1);
            }
        ...
        for (int ind = 0; ind < this.solutionSetSize_; ind++) {
            this.structure_[ind][0][Row.NE.ordinal()] =
                    this.structure_[this.structure_[ind][0][Row.N.ordinal()]][0][Row.E.ordinal()];
            this.structure_[ind][0][Row.NW.ordinal()] =
                    this.structure_[this.structure_[ind][0][Row.N.ordinal()]][0][Row.W.ordinal()];
            this.structure_[ind][0][Row.SE.ordinal()] =
                    this.structure_[this.structure_[ind][0][Row.S.ordinal()]][0][Row.E.ordinal()];
            this.structure_[ind][0][Row.SW.ordinal()] =
                    this.structure_[this.structure_[ind][0][Row.S.ordinal()]][0][Row.W.ordinal()];
        }
    } // Neighborhood
    ...
    public SolutionSet getFourNeighbors(SolutionSet solutionSet, int location) {
        ...
        //North
        index = this.structure_[location][0][Row.N.ordinal()];
