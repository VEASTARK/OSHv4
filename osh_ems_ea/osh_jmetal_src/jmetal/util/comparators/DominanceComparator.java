...
public class DominanceComparator implements Comparator {
    final IConstraintViolationComparator violationConstraintComparator_;
    ...
    public DominanceComparator(IConstraintViolationComparator comparator) {
        this.violationConstraintComparator_ = comparator;
    }
    ...
    public int compare(Object object1, Object object2) {
        ...
        if (this.violationConstraintComparator_.needToCompare(solution1, solution2))
            return this.violationConstraintComparator_.compare(solution1, solution2);
    /*
