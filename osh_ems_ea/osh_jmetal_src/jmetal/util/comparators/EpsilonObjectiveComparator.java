...
public class EpsilonObjectiveComparator implements Comparator {
    ...
    public int compare(Object o1, Object o2) {
        ...
        double objetive1 = ((Solution) o1).getObjective(this.objective_);
        double objetive2 = ((Solution) o2).getObjective(this.objective_);

        //Objetive implements comparable!!!
        return Double.compare(objetive1 / (1 + this.eta_), objetive2);
    } // compare
} // EObjectiveComparator
