...
public class PseudoRandom {
     ...
     */
    public int randInt() {
        return this.randomGenerator.getNextInt();
    } // randInt
    ...
    public DoubleStream randDoubleArray(int limit) {
        return this.randomGenerator.getDoubleArray(limit);
    }
    ...
    public double[] randDoubleArrayBound(int limit, double minBound, double maxBound) {
        return this.randomGenerator.getDoubleArrayBoundaries(limit, minBound, maxBound);
    }
    ...
    public int randInt(int minBound, int maxBound) {
        return minBound + this.randomGenerator.getNextInt(maxBound - minBound + 1);
    } // randInt
    ...
    public double randDouble(double minBound, double maxBound) {
        ...
        return minBound + this.randomGenerator.getNextDouble(max);
    ...
    public void randNextBytes(byte[] bytes) {
        this.randomGenerator.getNextBytes(bytes);
    }
