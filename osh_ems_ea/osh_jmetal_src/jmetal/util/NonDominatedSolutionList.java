    ...
    public boolean add(Solution solution) {
        if (!this.solutionsList_.isEmpty()) {
            ...
            while (iterator.hasNext()) {
                ...
                int flag = this.dominance_.compare(solution, listIndividual);

                if (flag < 0) {  // A solution in the list is dominated by the new one
                    iterator.remove();
                    ...
                    //}
                } else { // The new solution is dominated
                    return false;
                }
            } // while
            //} // if
