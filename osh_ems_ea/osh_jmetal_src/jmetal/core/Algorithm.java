...
public abstract class Algorithm implements Serializable {
     ...
     */
    protected final Problem problem_;

    /**
     * Stores the operators used by the algorithm, such as selection, crossover,
     * etc.
     */
    protected Map<String, Operator> operators_;
