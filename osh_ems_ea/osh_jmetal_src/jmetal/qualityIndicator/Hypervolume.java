...
public class Hypervolume {
    ...
    public static void main(String[] args) {
        ...
        //Obtain delta value
        double value = qualityIndicator.hypervolume(solutionFront, trueFront, Integer.parseInt(args[2]));
    ...
    public double calculateHypervolume(double[][] front, int noPoints, int noObjectives) {
        ...
        while (n > 0) {
            ...
            if (noObjectives < 3) {
                ...
                tempVolume = this.calculateHypervolume(front,
    ...
    public double hypervolume(double[][] paretoFront,
        ...
        maximumValues = this.utils_.getMaximumValues(paretoTrueFront, numberOfObjectives);
        minimumValues = this.utils_.getMinimumValues(paretoTrueFront, numberOfObjectives);

        // STEP 2. Get the normalized front
        normalizedFront = this.utils_.getNormalizedFront(paretoFront,
                maximumValues,
                minimumValues);

        // STEP 3. Inverse the pareto front. This is needed because of the original
        //metric by Zitzler is for maximization problems
        invertedFront = this.utils_.invertedFront(normalizedFront);
