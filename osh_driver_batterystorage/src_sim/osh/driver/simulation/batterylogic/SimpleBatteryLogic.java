...
public class SimpleBatteryLogic extends IBatteryControlLogic implements Serializable {
    ...
    public List<Integer> calculateChargePowers(
        ...
        listOfResults.add(batteryMaxChargePower);
        listOfResults.add(batteryMinChargePower);
        listOfResults.add(batteryMaxDischargePower);
        listOfResults.add(batteryMinDischargePower);
