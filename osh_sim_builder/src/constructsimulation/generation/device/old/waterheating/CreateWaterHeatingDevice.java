...
public class CreateWaterHeatingDevice {
    ...
    private static final String drawoffScheduleWeekdayFile = "configfiles/watertank/own/1p_wd_schedule.csv";
    private static final String drawoffScheduleWeekendFile = "configfiles/watertank/own/1p_we_schedule.csv";
...
//	private static String drawoffscheduleweekendfile = 	"configfiles/watertank/own/5p_we_schedule.csv";
    ...
    private static final String drawoffTypesFile = "configfiles/watertank/eu/eu_drawofftypesfile.csv";
...
//	private static String tankcapacity = "75"; // [liter]
    private static final String tankCapacity = "100"; // [liter]
    ...
    public static AssignedDevice createWaterHeatingDevice(
        ...
        }
        {
            ...
            for (String nP : pvNominalPower) {
                pvNominalPowerInt += Integer.parseInt(nP);
            }
