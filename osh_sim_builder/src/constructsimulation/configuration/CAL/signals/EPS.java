...
public class EPS {
    ...
    */
    public static UUID epsUuid = UUIDStorage.epsSignalUuid;
    ...
    public static int resolutionOfPriceSignal = 900; //15 minutes
    ...
    public static double activePowerExternalSupplyAvg = 30.0; // intended average tariff
    public static double activePowerExternalSupplyMax = 50.0;
    //EPS.CSV
    public static String csvPriceDynamicFilePath = FileReferenceStorage.csvPriceDynamicFilePath;
    //EPS.PVFEEDIN
    public static String pvFeedInEPEXFilePath = FileReferenceStorage.pvFeedInEPEXFilePath;
    //EPS.EEX
    public static EnumMap<EPSTypes, String> driverMap = new EnumMap<>(EPSTypes.class);
    public static String comManager = osh.mgmt.commanager.EpsProviderComManager.class.getName();
