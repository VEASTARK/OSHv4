...
public class PLS {
    ...
    */
    public static final UUID plsUuid = UUIDStorage.plsSignalUuid;
...
//	public static PLSTypes plsType = PLSTypes.REMS;
    ...
    public static final EnumMap<PLSTypes, String> driverMap = new EnumMap<>(PLSTypes.class);
    public static final String comManager = osh.mgmt.commanager.PlsProviderComManager.class.getName();
